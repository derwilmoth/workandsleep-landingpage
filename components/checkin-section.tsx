          ...
          {infoItems.map((item, index) => (
            <div
              ...
              className={`p-6 rounded-xl ${
                item.highlight
                  ? "bg-[#39393b] border-2 border-primary/50"
                  : "bg-[#39393b] border border-white/10"
              } shadow-lg`}
            >
              <div className="w-12 h-12 border rounded-lg flex items-center justify-center mb-4 bg-[#2d2d2e]">
