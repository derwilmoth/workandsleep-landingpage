      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
        <div className="mb-6 sm:mb-8">
          <Image
            ...
            width={700}
            height={350}
            className="mx-auto logo-glow w-[400px] sm:w-[600px] md:w-[700px] lg:w-[1000px] h-auto"
            priority
          />
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="cursor-pointer group relative inline-flex items-center justify-center px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-bold text-white bg-[#950a46] rounded-xl shadow-2xl shadow-[#950a46]/30 hover:shadow-[#950a46]/50 hover:scale-105 transition-all duration-300 overflow-hidden"
          >
