      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="pt-32 pb-24">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <Link
              href="/"
              className="inline-flex items-center gap-2 text-primary hover:text-[#e91e7d] mb-8"
            >
            ...
            <div className="prose prose-neutral max-w-none text-gray-800">
              ...
              <p className="mb-4 text-gray-700">
                ...
                17.02.2020-321153890) verfasst, um Ihnen gemäß der Vorgaben der
              ...
              <p className="mb-4 text-gray-700">
                Unser Online-Buchungssystem verwendet HTTP-Cookies um
                nutzerspezifische Daten zu speichern. Im Folgenden erklären wir,
                was Cookies sind und warum Sie genutzt werden, damit Sie die
              ...
              <p className="mb-4 text-gray-700">
                ...
                Ihre gewohnte Standardeinstellung. In einigen Browsern hat jedes
                Cookie eine eigene Datei, in anderen wie beispielsweise Firefox
              ...
              <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
                ...
                <li>
                  ...
                  User etwaige Fehlermeldungen bekommt.
                </li>
                <li>
                  <strong className="text-gray-900">
                ...
                <li>
                  <strong className="text-gray-900">Werbe-Cookies:</strong>{" "}
              ...
              <p className="mb-4 text-gray-700">
                ...
                teilweise zuzulassen oder zu deaktivieren.
              </p>
              <p className="mb-8 text-gray-700">
              ...
              <p className="mb-4 text-gray-700">
                Persönliche Daten, die Sie uns auf unserem Online-Buchungssystem
                elektronisch übermitteln, wie zum Beispiel Name, E-Mail-Adresse,
                Adresse oder andere persönlichen Angaben im Rahmen der
                Übermittlung eines Formulars oder Kommentaren im Blog, werden
                von uns gemeinsam mit dem Zeitpunkt und der IP-Adresse nur zum
              ...
              <p className="mb-8 text-gray-700">
                ...
                vertrauliche Daten niemals unverschlüsselt per E-Mail zu
                übermitteln.
              </p>
              ...
              <p className="mb-4 text-gray-700">
                Wir benützen auf unserer Website Google Maps der Firma Google
                Inc. (1600 Amphitheatre Parkway Mountain View, CA 94043, USA).
                Mit Google Maps können wir Standorte visuell besser darstellen
                und damit unser Service verbessern. Durch die Verwendung von
                Google Maps werden Daten an Google übertragen und auf den
              ...
              <p className="mb-4 text-gray-700">
                Google Maps ist ein Online-Kartendienst der Firma Google Inc.
                Mit Google Maps können Sie im Internet über einen PC oder über
                eine App genaue Standorte von Städten, Sehenswürdigkeiten,
              ...
              <p className="mb-4 text-gray-700">
                ...
                Webseite. Für die Verwendung von Google-Schriftarten müssen Sie
              ...
              <p className="mb-8 text-gray-700">
                ...
                Qualität unserer Webseite hoch zu halten.
              </p>
              ...
              <p className="mb-4 text-gray-700">
                ...
                besuchen, speichert unser Webserver automatisch Daten wie:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
              ...
              <p className="mb-4 text-gray-700">
                ...
                uns bestmöglich geschützt und sicher ist. Um das zu
                gewährleisten, verwenden wir Google reCAPTCHA der Firma Google
                Inc. (1600 Amphitheatre Parkway Mountain View, CA 94043, USA).
                Mit reCAPTCHA können wir feststellen, ob Sie auch wirklich ein
                Mensch aus Fleisch und Blut sind und kein Roboter oder eine
                andere Spam-Software.
              </p>
              ...
              <p className="mb-4 text-gray-700">
                ...
                Webseiten vor Spam-Software und den Missbrauch durch
                nicht-menschliche Besucher schützt. Am häufigsten wird dieser
                Dienst verwendet, wenn Sie Formulare im Internet ausfüllen.
              </p>
              ...
              <p className="mb-8 text-gray-700">
                ...
                getrost zuhause bleiben. Darum setzen wir alle Hebel in
                Bewegung, uns zu schützen und die bestmögliche
                Benutzerfreundlichkeit für Sie anzubieten.
              </p>
